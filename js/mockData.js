...
// ==============================================================================
// RED AMPLIADA DE 8 BODEGAS & SNEAKER PARTNERS EN CALI (DEMO MULTI-BODEGA)
// ==============================================================================
const NETWORK_BODEGAS_PRESET = [
  // 1. Vanessa Castellar Shoes (Bodega Matriz)
  {
    id: "store-001",
    name: "Vanessa Castellar Shoes",
    tagline: "Bodega Matriz Mayorista — San Andresito de la 38, Cali.",
    ...
    isSupplierStore: true,
    themeColor: "#e6192e",
    products: INITIAL_STORES[0].products
  },
  // 2. Cali Shoes Distribuidora (Partner)
  {
    id: "store-002",
    name: "Cali Shoes Distribuidora",
    tagline: "Boutique especializada en calzado importado exclusivo en el Sur de Cali (Afiliada a Vanessa).",
    ...
    isSupplierStore: false,
    themeColor: "#e6192e",
    products: INITIAL_STORES[1].products
  },
  // 3. Bodega El Diamante Kicks (Bodega Matriz)
  {
    id: "store-003",
    name: "Bodega El Diamante Kicks",
    tagline: "Distribuidora mayorista directa en Centro Comercial El Diamante. Despachos por bulto y docena.",
    phone: "573184567890",
    neighborhood: "C.C. El Diamante (Pasoancho con 39), Cali",
    isSupplierStore: true,
    themeColor: "#0284c7",
    products: INITIAL_STORES[0].products
  },
  // 4. Valle Urban Kicks (Partner)
  {
    id: "store-004",
    name: "Valle Urban Kicks",
    tagline: "Streetwear drops & calzado urbano en el corazón de Cali. Envíos contraentrega inmediatos.",
    phone: "573123456789",
    neighborhood: "Carrera 8va # 15-30 (Centro Histórico), Cali",
    isSupplierStore: false,
    themeColor: "#7c3aed",
    products: INITIAL_STORES[1].products
  },
  // 5. Pacífico Sneakers B2B (Bodega Matriz)
  {
    id: "store-005",
    name: "Pacífico Sneakers B2B",
    tagline: "Bodega importadora de calzado deportivo de alta gama. Stock permanente en San Fernando.",
    phone: "573167890123",
    neighborhood: "Calle 5ta # 27-14 (San Fernando / Alameda), Cali",
    isSupplierStore: true,
    themeColor: "#10b981",
    products: INITIAL_STORES[0].products
  },
  // 6. Stallion Shoes Cali (Partner)
  {
    id: "store-006",
    name: "Stallion Shoes Cali",
    tagline: "Showroom privado de zapatillas exclusivas en la Zona Rosa de Cali.",
    phone: "573145678901",
    neighborhood: "Av 9N # 12-45 (Granada / Santa Mónica), Cali",
    isSupplierStore: false,
    themeColor: "#f59e0b",
    products: INITIAL_STORES[1].products
  },
  // 7. Occidente Calzado Mayor (Bodega Matriz)
  {
    id: "store-007",
    name: "Occidente Calzado Mayor",
    tagline: "Gran bodega mayorista de calzado en San Andresito. Abasteciendo revendedores desde 2018.",
    phone: "573178901234",
    neighborhood: "San Andresito de la 38 Pasillo 2 Local 204, Cali",
    isSupplierStore: true,
    themeColor: "#e6192e",
    products: INITIAL_STORES[0].products
  },
  // 8. Royal Kicks Cali (Partner)
  {
    id: "store-008",
    name: "Royal Kicks Cali",
    tagline: "Tienda online premium con entregas el mismo día en el Norte de Cali y Menga.",
    phone: "573101234567",
    neighborhood: "Chipichape / La Flora (Comuna 2), Cali",
    isSupplierStore: false,
    themeColor: "#6366f1",
    products: INITIAL_STORES[1].products
  }
...
const NETWORK_ACCOUNTS_PRESET = {
  vanessa: DEMO_ACCOUNTS.vanessa,
  calishoes: DEMO_ACCOUNTS.calishoes,
  eldiamante: {
    id: "user-diamante-03",
    tenantId: "sup-003",
    storeId: "store-003",
    role: "supplier",
    name: "Bodega El Diamante Kicks",
    businessName: "Bodega El Diamante Kicks (C.C. El Diamante, Cali)",
    email: "diamante@kicks.com",
    username: "diamante",
    password: "Calishoes2026",
    pin: "3300",
    phone: "573184567890",
  ...
  valleurban: {
    ...
    role: "store-admin",
    name: "Valle Urban Kicks",
    businessName: "Valle Urban Kicks (Carrera 8va, Cali)",
    email: "valle@urbankicks.com",
    username: "valleurban",
    password: "Calishoes2026",
    pin: "4400",
    phone: "573123456789",
  ...
  pacificosneakers: {
    ...
    role: "supplier",
    name: "Pacífico Sneakers B2B",
    businessName: "Pacífico Sneakers B2B (San Fernando, Cali)",
    email: "pacifico@sneakers.com",
    username: "pacifico",
    password: "Calishoes2026",
    pin: "5500",
    phone: "573167890123",
  ...
  stallion: {
    ...
    role: "store-admin",
    name: "Stallion Shoes Cali",
    businessName: "Stallion Shoes Cali (Granada, Cali)",
    email: "stallion@shoes.com",
    username: "stallion",
    password: "Calishoes2026",
    pin: "6600",
    phone: "573145678901",
  ...
  occidentecalzado: {
    id: "user-occidente-07",
    tenantId: "sup-007",
    storeId: "store-007",
    role: "supplier",
    name: "Occidente Calzado Mayor",
    businessName: "Occidente Calzado Mayor (San Andresito 38)",
    email: "occidente@calzado.com",
    username: "occidente",
    password: "Calishoes2026",
    pin: "7700",
    phone: "573178901234",
  ...
  royalkicks: {
    ...
    role: "store-admin",
    name: "Royal Kicks Cali",
    businessName: "Royal Kicks Cali (Chipichape, Cali)",
    email: "royal@kicks.com",
    username: "royalkicks",
    password: "Calishoes2026",
    pin: "8800",
    phone: "573101234567",
